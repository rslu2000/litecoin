 ...
 */
#ifndef LITECOIN_UTIL_H
#define LITECOIN_UTIL_H
...
extern const char * const LITECOIN_CONF_FILENAME;
extern const char * const LITECOIN_PID_FILENAME;

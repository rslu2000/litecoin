...
#ifndef LITECOIN_QT_LITECOINUNITS_H
#define LITECOIN_QT_LITECOINUNITS_H
...
/** Litecoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class LitecoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit LitecoinUnits(QObject *parent);

    /** Litecoin units.
      @note Source: https://en.litecoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        LTC,
...
typedef LitecoinUnits::Unit LitecoinUnit;

#endif // LITECOIN_QT_LITECOINUNITS_H

...
public:
    CMainParams() {
        ...
        consensus.BIP34Height = 419450;
        consensus.BIP34Hash = uint256S("67147367b3a0849311dcf9c4c087c521630dad2ead338cade62de354bfc76be8");
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        // assert(consensus.hashGenesisBlock == uint256S("0x530827f38f93b43ed12af0b3ad25a288dc02ed74d6d7857862df51fc56c416f96"));

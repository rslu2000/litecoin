 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called Litecoin (https://www.litecoin.org/),
 * which enables instant payments to anyone, anywhere in the world. Litecoin uses peer-to-peer technology to operate
...
bool AppInit(int argc, char* argv[])
{
    ...
    // Parameters
    //
    // If Qt is used, parameters/litecoin.conf are parsed in qt/litecoin.cpp's main()

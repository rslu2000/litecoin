...
const char * const LITECOIN_CONF_FILENAME = "litecoin.conf";
const char * const LITECOIN_PID_FILENAME = "litecoind.pid";
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", LITECOIN_CONF_FILENAME));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", LITECOIN_PID_FILENAME));
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (strprintf(COPYRIGHT_HOLDERS, COPYRIGHT_HOLDERS_SUBSTITUTION).find("Litecoin Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Bitcoin Core developers & The Litecoin Core developers";
    }

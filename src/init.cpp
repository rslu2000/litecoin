...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), LITECOIN_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/wangxinxi/litecoin>";
    const std::string URL_WEBSITE = "<https://litecoincore.org>";
...
/** Sanity checks
 *  Ensure that Litecoin is running in a usable environment with all
